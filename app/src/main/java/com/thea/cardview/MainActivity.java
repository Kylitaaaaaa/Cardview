...
public class MainActivity extends AppCompatActivity {
    ...
    public void prepareReservation(){
        rList.add(new Reservation("Thea", 1));
        rList.add(new Reservation("JR", 3));
        rList.add(new Reservation("Kendall", 5));
        rList.add(new Reservation("Jeno", 20));
        rList.add(new Reservation("Kyle", 3));
        rList.add(new Reservation("Thea", 1));
        rList.add(new Reservation("JR", 3));
        rList.add(new Reservation("Kendall", 5));
        rList.add(new Reservation("Jeno", 20));
